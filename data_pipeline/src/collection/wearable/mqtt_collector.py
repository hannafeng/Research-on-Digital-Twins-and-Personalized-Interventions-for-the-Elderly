...
class MqttCollector:
    ...
    def __init__(self, data_callback: Callable[[Dict[str, Any]], None]):
        ...
        self.mqtt_config = {
            ...
            "broker_port": 1883,
            "client_id": "wearable_mqtt_collector",
            "topic": self.config["mqtt_topic"]
        }
        
        self.data_callback = data_callback
        self.client = None
        self.logger = logging.getLogger("MqttCollector")
    ...
    def start(self) -> None:
        ...
        try:
            ...
            self.logger.info("MQTT采集器已启动")
            
        except Exception as e:
            self.logger.error(f"启动MQTT采集器失败: {e}")
